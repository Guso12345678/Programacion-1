...
from funciones_epidemia import modeloSIR_tasa
...
#nym = float(input('Introduzca la tasa de mortalidad y natalidad: ')) #Tasa de natalidad y mortalidad
#vac = float(input('Introduzca la tasa de vacunacion: ')) #Primera tasa de vacunación
...
trasm = 0.08 # Tasa de propagación
recup = 0.025 #Tasa de recuperación
nym = 0.006 #Tasa de natalidad y mortalidad
vac = 0.01 #Primera tasa de vacunación
T = 300 #Días de epidemia


t, S, I, R = modeloSIR_tasa(S0, I0, R0, trasm, recup, nym, vac, T)

  
plt.plot(t, S, label='Suscetibles')
